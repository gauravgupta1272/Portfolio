      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          <form
            target="_blank"
            onSubmit={onSubmit}
            action="https://formsubmit.co/93113ba5178113d481992ad4410662cf"
            method="POST"
          >
            <input
            ...
            <button
              className="p-5 bg-yellow font-semibold text-deep-blue mt-5 hover:bg-red hover:text-white transition  rounded-lg duration-500"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
